...
const GCALL_SINGLE_SOURCE_TARGET_BOOST_SEVERE_MS = 112;
...
const GCALL_SINGLE_SOURCE_SEVERE_RECOVERY_TARGET_FLOOR_MS = 192;
...
const GCALL_SINGLE_SOURCE_SEVERE_LATCH_MS = 16_000;
const GCALL_SINGLE_SOURCE_SEVERE_CLEAR_BUFFERED_MS_MIN = 160;
const GCALL_SINGLE_SOURCE_SEVERE_CLEAR_DELTA_MIN_MS = -2;
