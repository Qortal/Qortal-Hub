...
// seconds
export const TIME_SECONDS_1_IN_MILLISECONDS: number = TIME_MILLISECONDS_1000;
...
export const TIME_MINUTES_5_IN_MILLISECONDS: number =
  5 * TIME_MINUTES_1_IN_MILLISECONDS;
