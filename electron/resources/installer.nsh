!macro customInstall
  ...
  ExecWait 'netsh advfirewall firewall add rule name="Qortal Hub Reticulum" dir=in action=allow program="$INSTDIR\resources\reticulum\rnsd.exe" enable=yes profile=private'
!macroend
